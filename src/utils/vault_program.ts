...
export type VaultProgram = {
  "address": "71eww9jmzMwBZ7kwqoovKZGeb54Mhvc5s3wtneQ1w8hp",
  "metadata": {
    "name": "vaultProgram",
    "version": "0.1.0",
    "spec": "0.1.0",
  ...
  "types": [
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          {
            "name": "totalInvestedSol",
            "type": "u64"
          },
          {
            "name": "totalInvestedToken",
            "type": "u64"
          },
          {
